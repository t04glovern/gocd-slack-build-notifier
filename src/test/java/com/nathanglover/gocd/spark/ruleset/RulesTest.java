...
import com.nathanglover.gocd.spark.Status;
...
public class RulesTest {
    ...
    private static PipelineRule pipelineRule(String pipeline, String stage, String room,
        Set<PipelineStatus> statuses) {
    ...
    public void shouldFindMatch() {
        ...
        rules.setPipelineRules(Arrays.asList(
            pipelineRule("pipeline1", "stage1", "ch1",
                statuses(PipelineStatus.BUILDING, PipelineStatus.FAILED)),
            pipelineRule("pipeline1", "stage2", "ch2",
                statuses(PipelineStatus.FIXED, PipelineStatus.PASSED)),
            pipelineRule("pipeline2", "stage2", "ch3",
                statuses(PipelineStatus.CANCELLED, PipelineStatus.BROKEN))
        ));

        List<PipelineRule> foundRules1 = rules
            .find("pipeline1", "stage1", "ci", Status.Building.getStatus());
        ...
        List<PipelineRule> foundRules2 = rules
            .find("pipeline2", "stage2", "ci", Status.Cancelled.getStatus());
        ...
        List<PipelineRule> foundRules3 = rules
            .find("pipeline2", "stage2", "ci", Status.Passed.getStatus());
    ...
    public void shouldFindMatchWithRegexp() {
        ...
        List<PipelineRule> foundRules1 = rules
            .find("abc", "efg", "ci", Status.Building.getStatus());
        assertThat(foundRules1.size(), is(1));
        ...
        List<PipelineRule> foundRules2 = rules
            .find("123", "456", "ci", Status.Building.getStatus());
        assertThat(foundRules2.size(), is(1));
        ...
        List<PipelineRule> foundRules4 = rules
            .find("pipeline1", "stage1", "ci", Status.Passed.getStatus());
    ...
    public void shouldFindAllMatchesIfProcessAllRules() {
        ...
        List<PipelineRule> foundRules1 = rules
            .find("abc", "stage1", "ci", Status.Building.getStatus());
        assertThat(foundRules1.size(), is(1));
        assertThat(foundRules1.get(0).getRoom(), is("ch1"));

        List<PipelineRule> foundRules2 = rules
            .find("abc", "stage2", "ci", Status.Building.getStatus());
        assertThat(foundRules2.size(), is(2));
        assertThat(foundRules2.get(0).getRoom(), is("ch1"));
        assertThat(foundRules2.get(1).getRoom(), is("ch2"));

        List<PipelineRule> foundRules3 = rules
            .find("abc1", "stage2", "ci", Status.Building.getStatus());
        assertThat(foundRules3.size(), is(0));
    }
