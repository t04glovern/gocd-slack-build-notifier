...
public class MaterialRevision {
    ...
    /**
     * Is this revision a pipeline, or something else (generally a commit to a version control
     * system)?
     */
    ...
    /**
     * Return a URL pointing to more information about one of our modifications, if we can figure
     * out how to generate one.  It's an error to call us with a modification that isn't part of
     * this MaterialRevision.  (This is implemented this way because Modification objects are
     * deserialized without any back-pointers to the containing MaterialRevision.)
     */
